        ...
        child:  Container(
          ...
          child: Column(
            children: [
              ...
              CupertinoListTile(title: const Text('Profile',style: TextStyle(
                  fontWeight: FontWeight.bold)),subtitle: const Text("Update Profile Data"),leading: const Icon(CupertinoIcons.person,size: 30),trailing: CupertinoSwitch(
                value: profileswitch,
                onChanged:(value) {
                  setState(() {
                    profileswitch = value;
              ...
              CupertinoListTile(title: const Text('Theme',style: TextStyle(
                  fontWeight: FontWeight.bold)),subtitle: const Text("Change Theme"),leading: const Icon(CupertinoIcons.sun_max,size: 30),trailing: CupertinoSwitch(
                value: Provider.of<ChangeThemeProvider>(context).changethemeModel.isDark,
                onChanged:(value) {
                  Provider.of<ChangeThemeProvider>(context,
                      listen: false)
                      .chnageTheme();
